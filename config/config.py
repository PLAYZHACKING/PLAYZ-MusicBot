...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://play-z-hacking:No-name-no@cluster0.dogzhpo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002792688261"))
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7107162691").split())
